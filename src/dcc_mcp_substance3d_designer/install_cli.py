"""Agent-first installer entry point for Substance 3D Designer."""
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    """Run the Designer lifecycle command."""
    ...
    try:
        ...
        if as_json:
            ...
            print("Designer lifecycle: invalid arguments", file=sys.stderr)
    ...
    if args.as_json:
        ...
        print(f"Designer {args.verb}: {outcome.result['status']}")
